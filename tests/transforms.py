...
class Test(unittest.TestCase):
    def test_R_transform(self):
       ...
       R(а5940000000000000000000000000000) = 0x64а59400000000000000000000000000,
       ...
       got = [
           tr.R_transform(0x00000000000000000000000000000100),
           tr.R_transform(0x94000000000000000000000000000001),
           tr.R_transform(0xa5940000000000000000000000000000),
           tr.R_transform(0x64a59400000000000000000000000000)
       ]
